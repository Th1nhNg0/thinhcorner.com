...
summary: "The future of AI is not predetermined, but rather depends on our choices, actions, and values, as humans and as societies. That’s why we need to be aware, informed, and responsible, when it comes to AI. We need to ask ourselves: What do we want from AI? What do we expect from AI? What do we trust from AI? And most importantly, what do we learn from AI?"
language: en
