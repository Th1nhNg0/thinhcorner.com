...
summary: Hướng dẫn code một bot chat thông minh tự động học bằng Python và Chatterbot.
language: vi
---
...
![Ví dụ 1 đoạn chat trên terminal](/images/chatterbot-python/chatterbot_demo.gif)
...
![Chat bot đơn giản](/images/chatterbot-python/chatterbot_simple.gif)
...
1. Chọn Connect Cluster
   ...
   ![mongo bước 1](/images/chatterbot-python/mongo_step_1.png)

2. Chọn Connect your application

   ![mongo bước 2](/images/chatterbot-python/mongo_step_2.png)
...
3. Chọn python phiên bản 3.3, và copy đường dẫn, trong đó admin, password là tài khoản của user bạn vừa tạo trong bài viết ở trên, dbname là tên database
   ...
   ![mongo bước 3](/images/chatterbot-python/mongo_step_3.png)
...
![Kết quả sau khi kết nối bot đến mongodb](/images/chatterbot-python/mongo_step_0.png)
...
![Thư mục bộ dữ liệu](/images/chatterbot-python/folder_chatterbot.png)
...
![Chạy thử với bộ dữ liệu Tiếng Việt](/images/chatterbot-python/chatterbot_vietnam.gif)
