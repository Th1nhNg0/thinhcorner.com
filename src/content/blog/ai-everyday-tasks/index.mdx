...
import benchmark640 from "./deepseek-benchmark-640.webp";
import benchmark720 from "./deepseek-benchmark-720.webp";
import benchmark960 from "./deepseek-benchmark-960.webp";
import benchmark1280 from "./deepseek-benchmark-1280.webp";
...
<picture>
  <source
    type="image/webp"
    srcSet={`${benchmark640.src} 640w, ${benchmark720.src} 720w, ${benchmark960.src} 960w, ${benchmark1280.src} 1280w`}
    sizes="(max-width: 48rem) calc(100vw - 2rem), 44rem"
  />
  <img
    src={benchmark640.src}
    alt="DeepSeek V4 Flash 0731 vendor-reported coding benchmarks"
    width={1280}
    height={705}
    loading="lazy"
    decoding="async"
    data-zoom-src={benchmark1280.src}
  />
</picture>
