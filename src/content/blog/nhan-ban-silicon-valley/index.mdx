---
title: 'Nhân bản Silicon Valley?'
date: 2025-04-10
description: 'Nhân bản Silicon Valley?'
draft: true
lang: "vi"
---
...
![](./Stanford_University_Aerial_View.jpg "Toàn cảnh Đại học Stanford nhìn từ trên cao, nổi bật với các tòa nhà trong khuôn viên có mái ngói đỏ đặc trưng. Ở trung tâm bức ảnh là Tháp Hoover mang tính biểu tượng.")
...
![](Replica-of-first-transistor.jpg "Một mô hình cách điệu của bóng bán dẫn đầu tiên")
...
![John Bardeen, William Shockley and Walter Brattain at Bell Labs, 1948](Bardeen_Shockley_Brattain_1948.JPG "John Bardeen, William Shockley và Walter Brattain tại Bell Labs, 1948")
...
![Jack Kilby](./Kilby_solid_circuit.jpg "Mạch tích hợp nguyên bản của Jack Kilby; mạch đầu tiên trên thế giới. Làm từ gecmani với các kết nối bằng dây vàng.")
...
![Fairchild-Semiconductor-founders](./Fairchild-Semiconductor-founders.jpg "Những nhà sáng lập Fairchild Semiconductor")
...
![74LS244_F_8314_annotated_sm](./74LS244_F_8314_annotated_sm.jpg "Ảnh chụp chip Fairchild có chú thích")
...
![FT-004-1](FT-004-1.jpg "Khu trưng bày năm 2016 tại sảnh CHM, giới thiệu các ví dụ về hàng trăm 'Fairchildren' (công ty tách ra từ Fairchild) đã ra đời qua sáu thế hệ liên doanh công nghệ")
...
![](./Intel_8742_153056995.jpg "Intel 8742, một vi điều khiển 8-bit tích hợp CPU chạy ở tốc độ 12 MHz, 128 byte RAM, 2048 byte EPROM và các cổng I/O (Nhập/Xuất) trên cùng một chip.")
...
![](./Andy_Grove_Robert_Noyce_Gordon_Moore_1978_edit.jpg "Andy Grove, Robert Noyce và Gordon Moore vào năm 1978")
...
![](./Intel_C4004.jpg "Một bộ vi xử lý Intel C4004 với các đường mạch màu xám")
...
![](Moores_Law_Transistor_Count_1970-2020.png "Biểu đồ bán logarit thể hiện số lượng bóng bán dẫn (transistor) của bộ vi xử lý theo ngày ra mắt, (cho thấy số lượng này) tăng gần gấp đôi sau mỗi hai năm.")
