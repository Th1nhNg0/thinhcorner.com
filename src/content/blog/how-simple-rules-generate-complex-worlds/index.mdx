...
The concept is very similar to [Constraint programming](https://en.wikipedia.org/wiki/Constraint_programming) – a programming paradigm where relations between variables are stated in the form of constraints – that I was researching in my article [Cracking the Scheduling Code in Hay Day](/blog/hayday-game-schedule) last year.
