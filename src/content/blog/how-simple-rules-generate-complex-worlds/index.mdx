...
In this article, we'll explore how simple rules can give rise to complex phenomena.
...
<YouTubeEmbed
  id="xP5-iIeKXE8"
  title="Game of Life Turing-complete explanation"
  className="w-full"
/>
...
I learned about the Game of Life from [The Coding Train](https://youtu.be/FWSR_7kZuYg?si=tkyfWgT1C1k3kJNZ) about six years ago. Since then, I’ve fallen in love with these concepts and started exploring them further.

## Wave Function Collapse Algorithm

In 2022, I found a game called [Townscaper](https://www.townscapergame.com/)—a game that lets you build a town by just clicking. It's a simple game, but the concept behind it is really interesting.

<YouTubeEmbed
  id="QtVkteAS15M"
  title="Townscaper wave function collapse explainer"
  className="w-full"
/>
...
Turns out, the game is using an algorithm called the **Wave Function Collapse algorithm** (WFC)—a greedy, computational algorithm that generates a grid of tiles based on a set of constraints. Developed by [Maxim Gumin](https://github.com/mxgmn) based on work by [Paul Merrell](https://paulmerrell.org/model-synthesis/).
...
You can see the visualization below by [Wave by Oskar Stålberg](https://oskarstalberg.com/game/wave/wave.html).
...
Here are some more examples from Maxim Gumin's [Wave Function Collapse](https://github.com/mxgmn/WaveFunctionCollapse) repository:

![Knots](./knots.png)

![Summer-1](./summer-1.webp)

This kind of programming is fascinating to me. It's like magic!

The concept is very similar to [Constraint programming](https://en.wikipedia.org/wiki/Constraint_programming) – a programming paradigm where relations between variables are stated in the form of constraints – that I was researching in my article [Cracking the Scheduling Code in Hay Day](/writing/hayday-game-schedule) last year.

## The Beauty of Emergence

From the deterministic dance of cells in the Game of Life to the seemingly random yet coherent structures generated by the Wave Function Collapse algorithm, we see a powerful principle at play: **complexity can arise from simplicity**. These examples, though different in their mechanisms, both demonstrate how a small set of well-defined rules, applied repeatedly, can lead to unpredictable and fascinating outcomes.

The implications of this idea stretch far beyond games and algorithms. We see similar patterns in nature, from the intricate formations of snowflakes to the complex social behaviors of ant colonies, all driven by relatively simple underlying rules. Understanding how these emergent phenomena occur not only satisfies our curiosity but also offers valuable insights into fields like artificial intelligence, urban planning, and even our understanding of the universe itself.

So, the next time you encounter something complex, take a moment to consider the simple rules that might be governing its behavior. You might be surprised by the elegant simplicity at its heart and the beautiful complexity that can emerge from it. What other examples of simple rules generating complex worlds come to your mind? Share your thoughts in the comments below!
