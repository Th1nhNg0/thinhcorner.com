...
<figure class="bg-zinc-800/50 rounded-xl shadow-lg">
  <Chart />
  <figcaption>Source: siliconvalleyindicators.org</figcaption>
</figure>
...
<figure class="bg-zinc-800/50 rounded-xl shadow-lg">
  <C3 />
  <figcaption>Source: WIPO Statistics Database</figcaption>
</figure>
...
<YouTubeEmbed
  id="ylj_5MX8TEs"
  title="Talk: Why IP is Vietnam's next growth lever"
  className="w-full"
/>
